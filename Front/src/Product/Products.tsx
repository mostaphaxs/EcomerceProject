...
export default function Products() {
  const {  SetWishListValue,  SetCartValue, Userrr,setUserrr} = useContext(AllthePageCanUseIt);
 ...
 const toggleWishlist = async (product: Product) => {
  ...
  const handleDetailsClick = (product: Product) => {
    ...
    axios.post("api/IncreaseView",{Userrr,Product_id},{
        headers:{Authorization:`Bearer ${Token}`}
    }).then(response => {
...
return (
  <div className="min-h-screen bg-gray-50 ">
    {/* Top Search Bar */}
    <div className="bg-gray-20 border-b border-gray-200 sticky top-0 z-40">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mb-8 space-y-4">
          <div className="text-center">
            <h2 className="text-xl font-bold text-gray-900 mb-4">{t("recommended_for_you")}</h2>
            <div className="flex flex-wrap justify-center gap-2">
          ...
          <div className="text-center">
            <span className="text-gray-600">
              {t("showing_products_count",{count: visibleProducts.length , total: filteredProducts.length} )}
  ...
  <div className="text-center py-12 px-4 bg-white rounded-lg border border-gray-200 shadow-sm">
    ...
    <h2 className="text-2xl font-bold text-gray-900 mb-3">
      {t("nothing_recommended_for_you")}
    </h2>
    
    <p className="text-gray-600 mb-4 text-lg">
      {t("nothing_recommended_subtitle")}
    </p>
